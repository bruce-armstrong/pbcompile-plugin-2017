 ...
 */
public class PbCompileBuilderTest {
    ...
    public void shouldStripQuotedArguments() {
        ...
        String[] tokenizedArgs = PbCompileBuilder.tokenizeArgs(quotedPlatform);
    ...
    public void shouldSplitArguments() {
        ...
        String[] tokenizedArgs = PbCompileBuilder.tokenizeArgs(arguments);
        assertNotNull(tokenizedArgs);
    ...
    public void endEscapedCharacter() {
        ...
        String[] tokenizedArgs = PbCompileBuilder.tokenizeArgs(oneArgumentsWithEndBackslash);
        assertEquals(1, tokenizedArgs.length);
